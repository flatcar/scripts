...
Patch54:        0054-docker-Add-hugepage-and-system-cronjob-support-for-i.patch
Patch55:        0055-systemd-Add-run-sysctl.d-support-for-systemd-sysctl.patch
...
%dir %{_usr}/share/containers/selinux
%config(noreplace) %{_usr}/share/containers/selinux/contexts
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/commit_num
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/users_extra
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/homedir_template
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/seusers
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/file_contexts
%verify(not md5 size mtime) %{_sharedstatedir}/selinux/%{policy_name}/active/modules_checksum
...
mkdir -p %{buildroot}%{_usr}/share/containers/selinux
install -m 644 %{SOURCE5} %{buildroot}%{_usr}/share/containers/selinux/contexts
...
* Thu Aug 21 2025 Chris PeBenito <chpebeni@microsoft.com> - 2.20250213-6
- Fix setxattr issue in cloud-init.

* Tue Aug 19 2025 Chris PeBenito <chpebeni@microsoft.com> - 2.20250213-5
- Update packaging for volatile semanage internal state files.

* Mon Jul 14 2025 Chris PeBenito <chpebeni@microsoft.com> - 2.20250213-4
- Add missing container contexts config file.

* Thu Jul 10 2025 Chris PeBenito <chpebeni@microsoft.com> - 2.20250213-3
- Add admin access to container engines for cloud-init.

* Thu Jun 19 2025 Chris PeBenito <chpebeni@microsoft.com> - 2.20250213-2
- Add hugepage and system cronjob support for docker interactive cli use.
- Fix /run/sysctl.d use.
