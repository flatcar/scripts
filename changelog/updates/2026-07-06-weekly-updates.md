...
- sysext-python: packaging ([26.2](https://github.com/pypa/packaging/releases/tag/26.2))
- sysext-python: pip ([26.1.2](https://raw.githubusercontent.com/pypa/pip/refs/tags/26.1.2/NEWS.rst))
- sysext-python: platformdirs ([4.10.0](https://github.com/tox-dev/platformdirs/releases/tag/4.10.0))
- sysext-python: requests ([2.34.2](https://github.com/psf/requests/releases/tag/v2.34.2) (includes [2.34.1](https://github.com/psf/requests/releases/tag/v2.34.1), [2.34.0](https://github.com/psf/requests/releases/tag/v2.34.0)))
- sysext-python: trove-classifiers ([2026.6.1.19](https://github.com/pypa/trove-classifiers/releases/tag/2026.6.1.19))
- vmware: xmlsec ([1.3.11](https://github.com/lsh123/xmlsec/releases/tag/1.3.11))
