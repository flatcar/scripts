...
<<<<<<<< HEAD:sdk_container/src/third_party/portage-stable/dev-lang/rust/rust-1.80.0.ebuild
	#"${FILESDIR}"/1.62.1-musl-dynamic-linking.patch  # Only used by upstream Gentoo, fails for 1.75
|||||||| parent of ec2bbf5934 (dev-lang/rust: Drop our custom package in favour of upstream Gentoo's):sdk_container/src/third_party/coreos-overlay/dev-lang/rust/rust-1.79.0.ebuild
	"${FILESDIR}"/1.78.0-ignore-broken-and-non-applicable-tests.patch
	#"${FILESDIR}"/1.62.1-musl-dynamic-linking.patch  # Only used by upstream Gentoo, fails for 1.75
========
	"${FILESDIR}"/1.78.0-ignore-broken-and-non-applicable-tests.patch
>>>>>>>> ec2bbf5934 (dev-lang/rust: Drop our custom package in favour of upstream Gentoo's):sdk_container/src/third_party/portage-stable/dev-lang/rust/rust-1.79.0.ebuild
