EXTRA_SYSEXTS=(
  ...
  "nvidia-drivers-570|x11-drivers/old-nvidia-drivers:0/570|-kernel-open persistenced|amd64"
  "nvidia-drivers-570-open|x11-drivers/old-nvidia-drivers:0/570|kernel-open persistenced|amd64"
